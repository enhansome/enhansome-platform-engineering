[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,703 | 🐛 106 | 📅 2026-08-21
...
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 1 | 🌐 Rust | 📅 2026-08-25 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,179 | 🐛 1,089 | 🌐 TypeScript | 📅 2026-08-25
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,373 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-24
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,383 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-24
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,324 | 🐛 1,327 | 🌐 TypeScript | 📅 2026-08-24
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,034 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-11
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,837 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-24
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,800 | 🐛 224 | 🌐 Go | 📅 2026-08-24
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,268 | 🐛 105 | 🌐 OCaml | 📅 2026-08-24
* [Artpie- open source artifact management alternative for Artifactory, Nexus etc.](https://github.com/artipie/artipie) ⭐ 689 | 🐛 86 | 🌐 Java | 📅 2026-06-20
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,151 | 🐛 95 | 🌐 Go | 📅 2026-08-24
* [tfsec- Terraform code security scanner](https://github.com/aquasecurity/tfsec) ⭐ 7,032 | 🐛 18 | 🌐 Go | 📅 2026-03-25
* [terrascan- detect compliance and security violations in IaC/Terraform](https://github.com/tenable/terrascan) ⚠️ Archived
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,693 | 🐛 326 | 🌐 Open Policy Agent | 📅 2026-08-24
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 869 | 🐛 2 | 🌐 Python | 📅 2026-08-23 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 410 | 🐛 0 | 🌐 Elixir | 📅 2026-08-25 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,104 | 🐛 56 | 🌐 Go | 📅 2026-08-24 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 127 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-25
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,854 | 🐛 163 | 🌐 Python | 📅 2026-08-24 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,311 | 🐛 796 | 🌐 Go | 📅 2026-08-25
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,523 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,146 | 🐛 129 | 📅 2025-11-28
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 31,931 | 🐛 1,535 | 🌐 TypeScript | 📅 2026-08-25
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,929 | 🐛 29 | 🌐 Java | 📅 2026-08-25
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,137 | 🐛 568 | 🌐 Go | 📅 2026-08-24
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 137 | 🌐 Ruby | 📅 2026-08-24
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,489 | 🐛 21 | 🌐 Go | 📅 2026-08-24
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,694 | 🐛 298 | 🌐 Go | 📅 2026-08-21
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,276 | 🐛 164 | 🌐 Java | 📅 2026-08-24
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,267 | 🐛 108 | 🌐 Go | 📅 2026-08-22
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,359 | 🐛 3 | 🌐 Java | 📅 2026-08-25
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,939 | 🐛 77 | 🌐 Go | 📅 2026-08-24
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,389 | 🐛 73 | 🌐 Go | 📅 2026-08-24
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,360 | 🐛 10 | 🌐 Go | 📅 2026-08-24
