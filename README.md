[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,995 | 🐛 106 | 📅 2026-09-02
...
* [Ota](https://github.com/ota-run/ota) ⭐ 81 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,388 | 🐛 1,102 | 🌐 TypeScript | 📅 2026-09-04
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,386 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,574 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-04
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,414 | 🐛 1,324 | 🌐 TypeScript | 📅 2026-09-04
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,861 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-04
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,817 | 🐛 229 | 🌐 Go | 📅 2026-09-04
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,279 | 🐛 111 | 🌐 OCaml | 📅 2026-09-04
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,171 | 🐛 100 | 🌐 Go | 📅 2026-08-24
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,699 | 🐛 317 | 🌐 Open Policy Agent | 📅 2026-09-03
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 889 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 354 | 🐛 0 | 🌐 Elixir | 📅 2026-09-04 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,248 | 🐛 85 | 🌐 Go | 📅 2026-09-04 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 132 | 🐛 89 | 🌐 TypeScript | 📅 2026-09-04
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,901 | 🐛 166 | 🌐 Python | 📅 2026-09-04 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,389 | 🐛 811 | 🌐 Go | 📅 2026-09-04
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,520 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,151 | 🐛 135 | 📅 2025-11-28
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,012 | 🐛 1,537 | 🌐 TypeScript | 📅 2026-09-04
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,940 | 🐛 40 | 🌐 Java | 📅 2026-09-02
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,188 | 🐛 577 | 🌐 Go | 📅 2026-09-03
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 134 | 🌐 Ruby | 📅 2026-09-02
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,507 | 🐛 20 | 🌐 Go | 📅 2026-09-02
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,723 | 🐛 301 | 🌐 Go | 📅 2026-09-02
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,294 | 🐛 142 | 🌐 Java | 📅 2026-09-04
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,341 | 🐛 106 | 🌐 Go | 📅 2026-09-03
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,362 | 🐛 10 | 🌐 Java | 📅 2026-09-04
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,947 | 🐛 113 | 🌐 Go | 📅 2026-09-03
