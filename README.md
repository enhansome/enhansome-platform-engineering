[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,593 | 🐛 106 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 648 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-21 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,577 | 🐛 1,074 | 🌐 TypeScript | 📅 2026-09-21
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,403 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-21
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,711 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-21
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,554 | 🐛 1,429 | 🌐 TypeScript | 📅 2026-09-21
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,892 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-21
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,845 | 🐛 223 | 🌐 Go | 📅 2026-09-21
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,283 | 🐛 112 | 🌐 OCaml | 📅 2026-09-21
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,191 | 🐛 108 | 🌐 Go | 📅 2026-09-21
* [tfsec- Terraform code security scanner](https://github.com/aquasecurity/tfsec) ⭐ 7,037 | 🐛 18 | 🌐 Go | 📅 2026-03-25
* [terrascan- detect compliance and security violations in IaC/Terraform](https://github.com/tenable/terrascan) ⚠️ Archived
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-21
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 957 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,418 | 🐛 87 | 🌐 Go | 📅 2026-09-21 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 137 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,989 | 🐛 145 | 🌐 Python | 📅 2026-09-21 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,539 | 🐛 828 | 🌐 Go | 📅 2026-09-21
...
* [OrcaReplay- record an agent or service run at its LLM-provider boundary and replay it offline, with no provider call and no API key](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 259 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,159 | 🐛 1,572 | 🌐 TypeScript | 📅 2026-09-21
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,958 | 🐛 46 | 🌐 Java | 📅 2026-09-21
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,230 | 🐛 541 | 🌐 Go | 📅 2026-09-21
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,588 | 🐛 134 | 🌐 Ruby | 📅 2026-09-20
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,528 | 🐛 23 | 🌐 Go | 📅 2026-09-21
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,755 | 🐛 304 | 🌐 Go | 📅 2026-09-16
...
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,450 | 🐛 95 | 🌐 Go | 📅 2026-09-21
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,367 | 🐛 15 | 🌐 Java | 📅 2026-09-21
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,954 | 🐛 83 | 🌐 Go | 📅 2026-09-21
...
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 12 | 🌐 Go | 📅 2026-09-21
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,733 | 🐛 45 | 📅 2024-08-02
