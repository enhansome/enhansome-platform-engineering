[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,278 | 🐛 106 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 642 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-31 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 1 | 🌐 Rust | 📅 2026-09-04 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,396 | 🐛 1,110 | 🌐 TypeScript | 📅 2026-09-05
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,386 | 🐛 13 | 🌐 JavaScript | 📅 2026-09-01
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,583 | 🐛 125 | 🌐 TypeScript | 📅 2026-09-04
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,417 | 🐛 1,325 | 🌐 TypeScript | 📅 2026-09-05
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,041 | 🐛 152 | 🌐 JavaScript | 📅 2026-09-01
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,863 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-05
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,818 | 🐛 229 | 🌐 Go | 📅 2026-09-04
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,279 | 🐛 113 | 🌐 OCaml | 📅 2026-09-04
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,173 | 🐛 100 | 🌐 Go | 📅 2026-08-24
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,698 | 🐛 317 | 🌐 Open Policy Agent | 📅 2026-09-03
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 890 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,256 | 🐛 78 | 🌐 Go | 📅 2026-09-05 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 132 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-05
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,904 | 🐛 166 | 🌐 Python | 📅 2026-09-05 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,395 | 🐛 812 | 🌐 Go | 📅 2026-09-05
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,019 | 🐛 1,540 | 🌐 TypeScript | 📅 2026-09-05
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,941 | 🐛 41 | 🌐 Java | 📅 2026-09-05
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,190 | 🐛 564 | 🌐 Go | 📅 2026-09-05
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 134 | 🌐 Ruby | 📅 2026-09-02
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,508 | 🐛 20 | 🌐 Go | 📅 2026-09-02
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,727 | 🐛 301 | 🌐 Go | 📅 2026-09-02
...
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,345 | 🐛 96 | 🌐 Go | 📅 2026-09-05
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,362 | 🐛 10 | 🌐 Java | 📅 2026-09-05
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,947 | 🐛 118 | 🌐 Go | 📅 2026-09-03
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,394 | 🐛 74 | 🌐 Go | 📅 2026-09-04
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,720 | 🐛 40 | 📅 2024-08-02
