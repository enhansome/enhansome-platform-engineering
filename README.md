[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 502,359 | 🐛 105 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 641 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-31 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
* [Ota](https://github.com/ota-run/ota) ⭐ 81 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,360 | 🐛 1,100 | 🌐 TypeScript | 📅 2026-09-02
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,386 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-01
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,549 | 🐛 121 | 🌐 TypeScript | 📅 2026-09-02
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,387 | 🐛 1,336 | 🌐 TypeScript | 📅 2026-09-02
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,854 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-02
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,815 | 🐛 226 | 🌐 Go | 📅 2026-09-02
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,279 | 🐛 110 | 🌐 OCaml | 📅 2026-09-02
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,164 | 🐛 100 | 🌐 Go | 📅 2026-08-24
...
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 354 | 🐛 0 | 🌐 Elixir | 📅 2026-09-02 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,214 | 🐛 69 | 🌐 Go | 📅 2026-09-02 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 131 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-02
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,894 | 🐛 162 | 🌐 Python | 📅 2026-09-02 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,375 | 🐛 804 | 🌐 Go | 📅 2026-09-02
...
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,029 | 🐛 59 | 🌐 Java | 📅 2026-09-02
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,002 | 🐛 1,553 | 🌐 TypeScript | 📅 2026-09-02
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,938 | 🐛 39 | 🌐 Java | 📅 2026-09-02
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,175 | 🐛 574 | 🌐 Go | 📅 2026-09-02
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,581 | 🐛 134 | 🌐 Ruby | 📅 2026-09-02
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,503 | 🐛 19 | 🌐 Go | 📅 2026-09-02
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,721 | 🐛 301 | 🌐 Go | 📅 2026-09-02
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,295 | 🐛 144 | 🌐 Java | 📅 2026-09-02
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,331 | 🐛 96 | 🌐 Go | 📅 2026-09-02
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,360 | 🐛 8 | 🌐 Java | 📅 2026-09-02
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,946 | 🐛 103 | 🌐 Go | 📅 2026-09-02
