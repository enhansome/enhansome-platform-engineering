[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,403 | 🐛 107 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 672 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-25 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
* [Ota](https://github.com/ota-run/ota) ⭐ 81 | 🐛 0 | 🌐 Rust | 📅 2026-09-25 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,615 | 🐛 1,076 | 🌐 TypeScript | 📅 2026-09-25
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,409 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-21
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,730 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-25
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,590 | 🐛 1,435 | 🌐 TypeScript | 📅 2026-09-25
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,898 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-25
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,856 | 🐛 219 | 🌐 Go | 📅 2026-09-25
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,283 | 🐛 113 | 🌐 OCaml | 📅 2026-09-25
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,199 | 🐛 108 | 🌐 Go | 📅 2026-09-22
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,707 | 🐛 319 | 🌐 Open Policy Agent | 📅 2026-09-25
...
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 337 | 🐛 11 | 🌐 Elixir | 📅 2026-09-25 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
* [Secure the software supply chain for OPA policies](https://github.com/opcr-io/policy) ⭐ 261 | 🐛 9 | 🌐 Go | 📅 2026-09-25
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,488 | 🐛 91 | 🌐 Go | 📅 2026-09-25 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
* [Agyn](https://github.com/agynio/platform) ⭐ 237 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - Kubernetes-native agent orchestration platform with Terraform-managed configuration (agents-as-code), audit logs, and scale-to-zero execution.
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 139 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-25
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 11,003 | 🐛 155 | 🌐 Python | 📅 2026-09-25 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,581 | 🐛 794 | 🌐 Go | 📅 2026-09-25
...
* [OrcaReplay- record an agent or service run at its LLM-provider boundary and replay it offline, with no provider call and no API key](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 265 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,195 | 🐛 1,570 | 🌐 TypeScript | 📅 2026-09-25
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,962 | 🐛 46 | 🌐 Java | 📅 2026-09-24
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,240 | 🐛 541 | 🌐 Go | 📅 2026-09-24
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,591 | 🐛 134 | 🌐 Ruby | 📅 2026-09-20
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,536 | 🐛 22 | 🌐 Go | 📅 2026-09-25
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,761 | 🐛 319 | 🌐 Go | 📅 2026-09-25
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,321 | 🐛 152 | 🌐 Java | 📅 2026-09-25
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,472 | 🐛 99 | 🌐 Go | 📅 2026-09-25
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,377 | 🐛 6 | 🌐 Java | 📅 2026-09-25
...
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 13 | 🌐 Go | 📅 2026-09-24
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,738 | 🐛 46 | 📅 2024-08-02
