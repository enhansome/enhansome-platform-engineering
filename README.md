[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 497,754 | 🐛 102 | 📅 2026-08-18
...
* [Ota](https://github.com/ota-run/ota) ⭐ 79 | 🐛 0 | 🌐 Rust | 📅 2026-08-18 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,117 | 🐛 1,080 | 🌐 TypeScript | 📅 2026-08-19
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,364 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-19
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,348 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-18
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,300 | 🐛 1,318 | 🌐 TypeScript | 📅 2026-08-19
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,831 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-19
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,785 | 🐛 213 | 🌐 Go | 📅 2026-08-19
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,263 | 🐛 144 | 🌐 OCaml | 📅 2026-08-19
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,688 | 🐛 327 | 🌐 Open Policy Agent | 📅 2026-08-19
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 848 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 416 | 🐛 2 | 🌐 Elixir | 📅 2026-08-19 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,006 | 🐛 54 | 🌐 Go | 📅 2026-08-19 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 127 | 🐛 32 | 🌐 TypeScript | 📅 2026-08-19
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,825 | 🐛 183 | 🌐 Python | 📅 2026-08-19 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,281 | 🐛 789 | 🌐 Go | 📅 2026-08-19
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,518 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,135 | 🐛 127 | 📅 2025-11-28
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 31,881 | 🐛 1,513 | 🌐 TypeScript | 📅 2026-08-19
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,924 | 🐛 21 | 🌐 Java | 📅 2026-08-15
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,118 | 🐛 565 | 🌐 Go | 📅 2026-08-19
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 139 | 🌐 Ruby | 📅 2026-08-17
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,470 | 🐛 22 | 🌐 Go | 📅 2026-08-18
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,684 | 🐛 296 | 🌐 Go | 📅 2026-08-18
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,268 | 🐛 168 | 🌐 Java | 📅 2026-08-19
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,226 | 🐛 106 | 🌐 Go | 📅 2026-08-18
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,358 | 🐛 14 | 🌐 Java | 📅 2026-08-19
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,936 | 🐛 75 | 🌐 Go | 📅 2026-08-19
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,387 | 🐛 72 | 🌐 Go | 📅 2026-08-18
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,359 | 🐛 12 | 🌐 Go | 📅 2026-08-11
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,714 | 🐛 38 | 📅 2024-08-02
