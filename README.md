[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,917 | 🐛 105 | 📅 2026-08-21
...
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 1 | 🌐 Rust | 📅 2026-08-22 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,147 | 🐛 1,079 | 🌐 TypeScript | 📅 2026-08-21
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,366 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-21
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,368 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-20
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,315 | 🐛 1,322 | 🌐 TypeScript | 📅 2026-08-22
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,034 | 🐛 152 | 🌐 JavaScript | 📅 2026-08-11
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,834 | 🐛 36 | 🌐 TypeScript | 📅 2026-08-22
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,792 | 🐛 223 | 🌐 Go | 📅 2026-08-22
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,267 | 🐛 104 | 🌐 OCaml | 📅 2026-08-22
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,148 | 🐛 95 | 🌐 Go | 📅 2026-08-18
* [tfsec- Terraform code security scanner](https://github.com/aquasecurity/tfsec) ⭐ 7,030 | 🐛 18 | 🌐 Go | 📅 2026-03-25
* [terrascan- detect compliance and security violations in IaC/Terraform](https://github.com/tenable/terrascan) ⚠️ Archived
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,692 | 🐛 327 | 🌐 Open Policy Agent | 📅 2026-08-21
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 857 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 409 | 🐛 5 | 🌐 Elixir | 📅 2026-08-21 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,044 | 🐛 57 | 🌐 Go | 📅 2026-08-22 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 127 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-22
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,842 | 🐛 183 | 🌐 Python | 📅 2026-08-21 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,295 | 🐛 791 | 🌐 Go | 📅 2026-08-22
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,521 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,141 | 🐛 128 | 📅 2025-11-28
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,028 | 🐛 63 | 🌐 Java | 📅 2026-08-06
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 31,915 | 🐛 1,521 | 🌐 TypeScript | 📅 2026-08-22
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,926 | 🐛 23 | 🌐 Java | 📅 2026-08-20
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,129 | 🐛 568 | 🌐 Go | 📅 2026-08-20
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 138 | 🌐 Ruby | 📅 2026-08-21
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,481 | 🐛 21 | 🌐 Go | 📅 2026-08-21
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,689 | 🐛 298 | 🌐 Go | 📅 2026-08-21
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,274 | 🐛 168 | 🌐 Java | 📅 2026-08-19
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,248 | 🐛 103 | 🌐 Go | 📅 2026-08-22
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,358 | 🐛 18 | 🌐 Java | 📅 2026-08-22
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,937 | 🐛 76 | 🌐 Go | 📅 2026-08-20
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,388 | 🐛 73 | 🌐 Go | 📅 2026-08-21
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,359 | 🐛 10 | 🌐 Go | 📅 2026-08-20
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,716 | 🐛 39 | 📅 2024-08-02
