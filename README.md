[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 509,905 | 🐛 107 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 669 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 0 | 🌐 Rust | 📅 2026-09-24 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
* [YYLO](https://github.com/yylo-dev/yylo) ⭐ 61 | 🐛 10 | 🌐 Python | 📅 2026-09-24 - Command-line orchestrator for coding agents and repeatable workflows with typed task, validation, merge, and release-readiness boundaries; each task runs in a dedicated branch/worktree and a merge queue owns risk-based review for receipt-backed repository changes.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,607 | 🐛 1,077 | 🌐 TypeScript | 📅 2026-09-24
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,408 | 🐛 15 | 🌐 JavaScript | 📅 2026-09-21
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,722 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-24
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,582 | 🐛 1,437 | 🌐 TypeScript | 📅 2026-09-24
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,039 | 🐛 156 | 🌐 JavaScript | 📅 2026-09-17
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,899 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-24
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,851 | 🐛 219 | 🌐 Go | 📅 2026-09-24
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,283 | 🐛 115 | 🌐 OCaml | 📅 2026-09-24
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,197 | 🐛 108 | 🌐 Go | 📅 2026-09-22
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,707 | 🐛 317 | 🌐 Open Policy Agent | 📅 2026-09-24
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 968 | 🐛 3 | 🌐 Python | 📅 2026-09-24 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 336 | 🐛 11 | 🌐 Elixir | 📅 2026-09-24 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,467 | 🐛 92 | 🌐 Go | 📅 2026-09-24 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 138 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,999 | 🐛 156 | 🌐 Python | 📅 2026-09-24 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,570 | 🐛 792 | 🌐 Go | 📅 2026-09-24
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,517 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,168 | 🐛 140 | 📅 2025-11-28
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,030 | 🐛 64 | 🌐 Java | 📅 2026-09-17
* [OrcaReplay- record an agent or service run at its LLM-provider boundary and replay it offline, with no provider call and no API key](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 263 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-23
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,188 | 🐛 1,567 | 🌐 TypeScript | 📅 2026-09-24
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,962 | 🐛 46 | 🌐 Java | 📅 2026-09-24
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,238 | 🐛 536 | 🌐 Go | 📅 2026-09-24
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,591 | 🐛 134 | 🌐 Ruby | 📅 2026-09-20
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,533 | 🐛 21 | 🌐 Go | 📅 2026-09-24
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,759 | 🐛 313 | 🌐 Go | 📅 2026-09-23
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,320 | 🐛 154 | 🌐 Java | 📅 2026-09-24
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,466 | 🐛 96 | 🌐 Go | 📅 2026-09-24
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,376 | 🐛 4 | 🌐 Java | 📅 2026-09-24
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,956 | 🐛 84 | 🌐 Go | 📅 2026-09-23
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,404 | 🐛 74 | 🌐 Go | 📅 2026-09-04
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 12 | 🌐 Go | 📅 2026-09-24
