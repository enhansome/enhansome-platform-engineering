[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,183 | 🐛 105 | 📅 2026-08-21
...
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,206 | 🐛 1,094 | 🌐 TypeScript | 📅 2026-08-26
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,375 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-24
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,391 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-26
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,349 | 🐛 1,330 | 🌐 TypeScript | 📅 2026-08-26
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,035 | 🐛 151 | 🌐 JavaScript | 📅 2026-08-11
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,843 | 🐛 33 | 🌐 TypeScript | 📅 2026-08-26
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,807 | 🐛 219 | 🌐 Go | 📅 2026-08-26
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,268 | 🐛 105 | 🌐 OCaml | 📅 2026-08-26
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,155 | 🐛 95 | 🌐 Go | 📅 2026-08-24
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,695 | 🐛 324 | 🌐 Open Policy Agent | 📅 2026-08-25
...
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 382 | 🐛 0 | 🌐 Elixir | 📅 2026-08-26 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,131 | 🐛 54 | 🌐 Go | 📅 2026-08-26 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 128 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-26
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,864 | 🐛 161 | 🌐 Python | 📅 2026-08-26 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,327 | 🐛 799 | 🌐 Go | 📅 2026-08-26
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,523 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,146 | 🐛 132 | 📅 2025-11-28
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,028 | 🐛 58 | 🌐 Java | 📅 2026-08-24
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 31,930 | 🐛 1,545 | 🌐 TypeScript | 📅 2026-08-26
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,930 | 🐛 42 | 🌐 Java | 📅 2026-08-26
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,144 | 🐛 557 | 🌐 Go | 📅 2026-08-26
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,578 | 🐛 137 | 🌐 Ruby | 📅 2026-08-24
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,492 | 🐛 21 | 🌐 Go | 📅 2026-08-24
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,697 | 🐛 297 | 🌐 Go | 📅 2026-08-26
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,282 | 🐛 170 | 🌐 Java | 📅 2026-08-26
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,276 | 🐛 110 | 🌐 Go | 📅 2026-08-25
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,360 | 🐛 3 | 🌐 Java | 📅 2026-08-26
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,940 | 🐛 78 | 🌐 Go | 📅 2026-08-26
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,390 | 🐛 73 | 🌐 Go | 📅 2026-08-24
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,360 | 🐛 10 | 🌐 Go | 📅 2026-08-25
...
* [Platform Engineering list](https://github.com/toptechevangelist/awesome-platform-engineering) ⭐ 244 | 🐛 5 | 📅 2026-08-17
