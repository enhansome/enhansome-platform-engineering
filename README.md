[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 508,977 | 🐛 106 | 📅 2026-09-02
...
* [SandBase Harness](https://github.com/sandbaseai/sandbase-harness) ⭐ 650 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-22 - Local-first agent runtime and MCP bridge for auditable sessions, sandboxed execution, approvals, and Docker/Kubernetes-backed platform workflows.
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 0 | 🌐 Rust | 📅 2026-09-22 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
* [YYLO](https://github.com/yylo-dev/yylo) ⭐ 60 | 🐛 10 | 🌐 Python | 📅 2026-09-21 - Command-line orchestrator for coding agents and repeatable workflows with typed task, validation, merge, and release-readiness boundaries; each task runs in a dedicated branch/worktree and a merge queue owns risk-based review for receipt-backed repository changes.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,583 | 🐛 1,073 | 🌐 TypeScript | 📅 2026-09-22
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,405 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-21
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,713 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-21
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,563 | 🐛 1,429 | 🌐 TypeScript | 📅 2026-09-22
* [Upgrade JavaScript or TypeScript codebases](https://github.com/facebook/jscodeshift) ⭐ 10,038 | 🐛 155 | 🌐 JavaScript | 📅 2026-09-17
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,896 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-22
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,847 | 🐛 225 | 🌐 Go | 📅 2026-09-22
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,284 | 🐛 113 | 🌐 OCaml | 📅 2026-09-22
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,192 | 🐛 108 | 🌐 Go | 📅 2026-09-22
* [tfsec- Terraform code security scanner](https://github.com/aquasecurity/tfsec) ⭐ 7,038 | 🐛 18 | 🌐 Go | 📅 2026-03-25
* [terrascan- detect compliance and security violations in IaC/Terraform](https://github.com/tenable/terrascan) ⚠️ Archived
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,704 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-22
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 963 | 🐛 3 | 🌐 Python | 📅 2026-09-21 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 336 | 🐛 5 | 🌐 Elixir | 📅 2026-09-21 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
* [Secure the software supply chain for OPA policies](https://github.com/opcr-io/policy) ⭐ 261 | 🐛 8 | 🌐 Go | 📅 2026-09-18
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,434 | 🐛 84 | 🌐 Go | 📅 2026-09-22 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
* [Agyn](https://github.com/agynio/platform) ⭐ 235 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-19 - Kubernetes-native agent orchestration platform with Terraform-managed configuration (agents-as-code), audit logs, and scale-to-zero execution.
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 137 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,996 | 🐛 152 | 🌐 Python | 📅 2026-09-22 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,549 | 🐛 795 | 🌐 Go | 📅 2026-09-22
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,516 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,169 | 🐛 141 | 📅 2025-11-28
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,030 | 🐛 64 | 🌐 Java | 📅 2026-09-17
* [OrcaReplay- record an agent or service run at its LLM-provider boundary and replay it offline, with no provider call and no API key](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 260 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-22
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,170 | 🐛 1,577 | 🌐 TypeScript | 📅 2026-09-22
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,959 | 🐛 47 | 🌐 Java | 📅 2026-09-22
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,232 | 🐛 534 | 🌐 Go | 📅 2026-09-22
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,590 | 🐛 134 | 🌐 Ruby | 📅 2026-09-20
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,530 | 🐛 23 | 🌐 Go | 📅 2026-09-21
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,756 | 🐛 307 | 🌐 Go | 📅 2026-09-16
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,316 | 🐛 156 | 🌐 Java | 📅 2026-09-21
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,457 | 🐛 95 | 🌐 Go | 📅 2026-09-22
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,374 | 🐛 16 | 🌐 Java | 📅 2026-09-22
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,954 | 🐛 84 | 🌐 Go | 📅 2026-09-21
* [Ory Keto- Open-source implementation of "Zanzibar: Google's Authorization System"](https://github.com/ory/keto) ⭐ 5,401 | 🐛 74 | 🌐 Go | 📅 2026-09-04
* [Topaz- Combining the best of OPA and Zanzibar](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 12 | 🌐 Go | 📅 2026-09-22
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,735 | 🐛 45 | 📅 2024-08-02
