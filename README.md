[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,121 | 🐛 106 | 📅 2026-09-02
...
* [YYLO](https://github.com/yylo-dev/yylo) ⭐ 60 | 🐛 10 | 🌐 Python | 📅 2026-09-17 - Command-line orchestrator for coding agents and repeatable workflows with typed task, validation, merge, and release-readiness boundaries; each task runs in a dedicated branch/worktree and a merge queue owns risk-based review for receipt-backed repository changes.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,525 | 🐛 1,067 | 🌐 TypeScript | 📅 2026-09-17
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,397 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-14
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,692 | 🐛 123 | 🌐 TypeScript | 📅 2026-09-16
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,525 | 🐛 1,453 | 🌐 TypeScript | 📅 2026-09-17
...
* [Verdaccio- a simple, zero-config npm registry](https://github.com/verdaccio/verdaccio) ⭐ 17,887 | 🐛 43 | 🌐 TypeScript | 📅 2026-09-17
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,837 | 🐛 244 | 🌐 Go | 📅 2026-09-17
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,281 | 🐛 113 | 🌐 OCaml | 📅 2026-09-17
...
* [kube-bench checks whether Kubernetes security is aording to CIS K8S Benchmark](https://github.com/aquasecurity/kube-bench) ⭐ 8,189 | 🐛 106 | 🌐 Go | 📅 2026-09-07
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,700 | 🐛 312 | 🌐 Open Policy Agent | 📅 2026-09-17
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 946 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 353 | 🐛 1 | 🌐 Elixir | 📅 2026-09-17 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,367 | 🐛 90 | 🌐 Go | 📅 2026-09-17 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 137 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-17
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,973 | 🐛 170 | 🌐 Python | 📅 2026-09-17 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,518 | 🐛 795 | 🌐 Go | 📅 2026-09-17
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,516 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,166 | 🐛 140 | 📅 2025-11-28
* [Hydra Lab: build your intelligent cloud testing system](https://github.com/microsoft/HydraLab) ⭐ 1,030 | 🐛 64 | 🌐 Java | 📅 2026-09-17
* [OrcaReplay- record an agent or service run at its LLM-provider boundary and replay it offline, with no provider call and no API key](https://github.com/Continuum-AI-Corp/OrcaReplay) ⭐ 254 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-17
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,116 | 🐛 1,576 | 🌐 TypeScript | 📅 2026-09-17
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,955 | 🐛 45 | 🌐 Java | 📅 2026-09-17
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,217 | 🐛 551 | 🌐 Go | 📅 2026-09-16
* [Fluentd CNCF: Unified Logging Layer](https://github.com/fluent/fluentd) ⭐ 13,587 | 🐛 134 | 🌐 Ruby | 📅 2026-09-15
* [Infracost- cost estimates for Terraform](https://github.com/infracost/infracost) ⭐ 12,521 | 🐛 22 | 🌐 Go | 📅 2026-09-09
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,748 | 🐛 304 | 🌐 Go | 📅 2026-09-16
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,310 | 🐛 145 | 🌐 Java | 📅 2026-09-14
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,419 | 🐛 96 | 🌐 Go | 📅 2026-09-17
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,366 | 🐛 17 | 🌐 Java | 📅 2026-09-17
* [Permify- open-source authorization service](https://github.com/Permify/permify) ⭐ 5,952 | 🐛 77 | 🌐 Go | 📅 2026-09-17
