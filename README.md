[![Awesome badge](https://awesome.re/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 505,415 | 🐛 106 | 📅 2026-09-02
...
* [Ota](https://github.com/ota-run/ota) ⭐ 80 | 🐛 0 | 🌐 Rust | 📅 2026-09-12 - Open-source repo execution governance with machine-readable contracts for setup, verification, workflows, runtime proof, and agent-safe execution.
* [YYLO](https://github.com/yylo-dev/yylo) ⭐ 59 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - Command-line orchestrator for coding agents and repeatable workflows with typed task, validation, merge, and release-readiness boundaries; each task runs in a dedicated branch/worktree and a merge queue owns risk-based review for receipt-backed repository changes.
...
* [Ant Design- An enterprise-class UI design language and React UI library](https://github.com/ant-design/ant-design) ⭐ 99,491 | 🐛 1,073 | 🌐 TypeScript | 📅 2026-09-12
* [commander.js- nNode.js CLI development framework](https://github.com/tj/commander.js/) ⭐ 28,389 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-01
* [Capacitor- cross-platform web apps building framework](https://github.com/ionic-team/capacitor) ⭐ 16,649 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-11
...
* [Update NPM, pip, Gem etc. dependencies](https://github.com/renovatebot/renovate) ⭐ 22,477 | 🐛 1,319 | 🌐 TypeScript | 📅 2026-09-12
...
* [Terragrunt for deployment environments (dev/staging/prod) and other features](https://github.com/gruntwork-io/terragrunt) ⭐ 9,830 | 🐛 230 | 🌐 Go | 📅 2026-09-12
* [Terrateam - GitOps-first open-source IaC automation for Terraform, OpenTofu, and more](https://github.com/terrateamio/terrateam) ⭐ 1,281 | 🐛 111 | 🌐 OCaml | 📅 2026-09-12
...
* [KICS by Checkmarx- detect security vulnerabilities, compliance issues, and infrastructure misconfigurations](https://github.com/Checkmarx/kics) ⭐ 2,698 | 🐛 316 | 🌐 Open Policy Agent | 📅 2026-09-11
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 920 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI penetration testing platform covering web, API, Active Directory and Kubernetes.
* [emisar](https://github.com/AndrewDryga/emisar) ⭐ 353 | 🐛 8 | 🌐 Elixir | 📅 2026-09-12 - A control plane for giving AI agents limited, auditable access to infrastructure operations through defined actions and policy rules.
...
* [Radar](https://github.com/skyhook-io/radar) ⭐ 3,338 | 🐛 98 | 🌐 Go | 📅 2026-09-12 - Open-source Kubernetes visibility tool for topology, events, resources, Helm, GitOps, traffic, cost, audit, access control, and MCP for AI tools.
...
* [KubeStellar Console - Multi-cluster Kubernetes dashboard with AI-powered operations and real-time observability](https://github.com/kubestellar/console) ⭐ 134 | 🐛 143 | 🌐 TypeScript | 📅 2026-09-12
...
* [BunkerWeb](https://github.com/bunkerity/bunkerweb) ⭐ 10,935 | 🐛 169 | 🌐 Python | 📅 2026-09-12 - Open-source Web Application Firewall and reverse proxy.
...
* [k6- performance/load testing tool](https://github.com/grafana/k6) ⭐ 31,455 | 🐛 802 | 🌐 Go | 📅 2026-09-12
* [ddosify- performance testing platform](https://github.com/ddosify/ddosify) ⭐ 8,515 | 🐛 19 | 🌐 Go | 📅 2026-03-04
* [Awesome Test Automation- a list of test automation frameworks, tools etc.](https://github.com/atinfo/awesome-test-automation) ⭐ 7,158 | 🐛 137 | 📅 2025-11-28
...
* [SigNoz- an open-source alternative to DataDog, NewRelic, etc.](https://github.com/signoz/signoz) ⭐ 32,086 | 🐛 1,554 | 🌐 TypeScript | 📅 2026-09-11
* [Apache SkyWalking — Application Performance Monitoring](https://github.com/apache/skywalking) ⭐ 24,948 | 🐛 42 | 🌐 Java | 📅 2026-09-12
* [Jaeger CNCF- a Distributed Tracing Platform](https://github.com/jaegertracing/jaeger) ⭐ 23,203 | 🐛 556 | 🌐 Go | 📅 2026-09-10
...
* [OpenCost — open source cost monitoring tool for Kubernetes](https://github.com/opencost/opencost) ⭐ 6,744 | 🐛 306 | 🌐 Go | 📅 2026-09-11
...
* [SuperTokens- Open Source User Authentication](https://github.com/supertokens/supertokens-core) ⭐ 15,298 | 🐛 144 | 🌐 Java | 📅 2026-09-11
* [Casdoor- IAM/SSO platform with web UI](https://github.com/casdoor/casdoor) ⭐ 14,391 | 🐛 95 | 🌐 Go | 📅 2026-09-12
* [CAS- Central Authentication Service](https://github.com/apereo/cas) ⭐ 11,363 | 🐛 7 | 🌐 Java | 📅 2026-09-12
...
* [DevSecOps resources and tooling](https://github.com/TaptuIT/awesome-devsecops/) ⭐ 1,727 | 🐛 43 | 📅 2024-08-02
